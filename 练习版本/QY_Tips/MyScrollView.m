...
//        暗夜滑动
        ...
        self.myPage = [[UIPageControl alloc]initWithFrame:CGRectMake(self.scroll.frame.size.width / 5 + 20,self.scroll.frame.size.height  - 40, self.scroll.frame.size.width / 2,self.scroll.frame.size.height / 6)];
...
- (void)setImages:(NSMutableArray *)names{
    ...
    self.myPage.numberOfPages = names.count - 2;
